...
echo "iptables -I INPUT -p tcp --dport 8443 -j ACCEPT" > /rooc/cluster_up.sh
echo "iptables -I INPUT -p tcp --dport 443 -j ACCEPT" >> /rooc/cluster_up.sh
echo "iptables -I INPUT -p tcp --dport 80 -j ACCEPT" >> /rooc/cluster_up.sh
echo "iptables -I INPUT -p tcp --dport 8080 -j ACCEPT" >> /rooc/cluster_up.sh
chmod +x /root/cluster_up.sh
#Reemplace su IP en la linea de abajo
